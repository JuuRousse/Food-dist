...
function modal() {
    ...
    function showModalByScroll() {
        ...
        if (Math.ceil(windowPageYOffset + documentClientHeight) >= documentScrollHeight) {
            openModal();
...
function slider() {
    ...
    const slidesField = document.querySelector('.offer-slider-inner');
...
function timer() {
    ...
    const deadline = '2021-02-25 12:44';
